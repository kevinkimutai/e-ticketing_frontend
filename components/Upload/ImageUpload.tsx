...
const ImageUpload = ({ onImageURL }: ComponentProps) => {
  ...
  return (
    <div
      className={`w-full min-h-[15rem] flex flex-col justify-center items-center p-4 border border-slate-600 rounded-md mb-2 overflow-hidden`}
    >
      {loading ? (
        ...
        <div className="flex flex-col justify-center items-center">
          <p>Upload Your Event Poster Here</p>
          <label htmlFor="file-upload" className="">
            <UploadCloud className="3xl cursor-pointer" />
          </label>
          <input
            id="file-upload"
            type="file"
